...
FORECAST_CSV  = os.path.join(PROCESSED_DIR, "forecast_univariant.csv")
MV_FORECAST_CSV = os.path.join(PROCESSED_DIR, "forecast_multivariant.csv")
ANOMALY_CSV   = os.path.join(PROCESSED_DIR, "anomaly_detection.csv")
